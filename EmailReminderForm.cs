        ...
        private void btnSendEmailReminder_Click(object sender, EventArgs e)
        {
            ...
            if (!string.IsNullOrWhiteSpace(emailAddress))
            {
                try
                {
                    ...
                    if (!string.IsNullOrWhiteSpace(txtAttachmentFilePath.Text))
                    {
                        Attachment attachment = new Attachment(txtAttachmentFilePath.Text);
                    ...
                    if (!string.IsNullOrWhiteSpace(txtSmtpUsername.Text) && !string.IsNullOrWhiteSpace(txtSmtpPassword.Text))
                    {
